...
Revision ID: 778a3b45473b
Revises: 
Create Date: 2021-06-24 22:15:46.409896
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['commonData.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('cathedraAssign',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('professor_id', sa.Integer(), nullable=True),
...
def downgrade():
    ...
    op.drop_table('cathedraAssign')
    op.drop_table('user')
    op.drop_table('cathedra')
    op.drop_table('student')
    op.drop_table('professor')
    op.drop_table('commonData')
    # ### end Alembic commands ###
